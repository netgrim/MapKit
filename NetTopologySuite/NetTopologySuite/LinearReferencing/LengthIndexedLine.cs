...
namespace NetTopologySuite.LinearReferencing
{
    ...
    public class LengthIndexedLine
    {
        ...
        public Coordinate ExtractPointM(double index)
        {
            var loc = LengthLocationMap.GetLocation(_linearGeom, index);
            var coord = loc.GetCoordinate(_linearGeom);
            coord.M = index;
            return coord;
        }
        ...
        public Coordinate ExtractPointM(double index, double offsetDistance)
        {
            var loc = LengthLocationMap.GetLocation(_linearGeom, index);
            var coord = loc.GetSegment(_linearGeom).PointAlongOffset(loc.SegmentFraction, offsetDistance);
            coord.M = index;
            return coord;
        }
