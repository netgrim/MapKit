    ...
    public class Point : Geometry, IPoint
    {
        ...
        {               
            if (coordinates == null) 
                ...
                _geometryType = coordinates.Count > 0 ? ToGeometryType(coordinates.Ordinates) : GeoAPI.Geometries.OgcGeometryType.Point;
        ...
        private GeoAPI.Geometries.OgcGeometryType ToGeometryType(Ordinates ordinates)
        {
            switch (ordinates)
            {
                case Ordinates.XY: return OgcGeometryType.Point;
                case Ordinates.XYZ: return OgcGeometryType.PointZ;
                case Ordinates.XYM: return OgcGeometryType.PointM;
                case Ordinates.XYZM: return OgcGeometryType.PointZM;
        ...
        public double M
        {
            get
            {
				return _coordinates.GetOrdinate(0, Ordinate.M); 
            }
            set
            {
				_coordinates.SetOrdinate(0, Ordinate.M, value);
            }
        }
