...
//#endif
    public sealed class CoordinateArraySequenceFactory : ICoordinateSequenceFactory
    {
		...
		public ICoordinateSequence Create(int size, int dimension)
		{
			switch (dimension)
			{
				case 2: return new CoordinateArraySequence(size, Ordinates.XY);
				case 3: return new CoordinateArraySequence(size, Ordinates.XYZ);
				case 4: return new CoordinateArraySequence(size, Ordinates.XYZM);
				default:
